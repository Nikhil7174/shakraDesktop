...
export class ProcessMonitor {
  ...
  private readonly blockedApps = [
    ...
    'msedge', 'iexplore', 'waterfox', 'pale moon', 'chrome', 'chromium', 'firefox',
    ...
    'parakeet', 'parakeet ai', 'interview copilot', 'live interview', 'live interview ai',
    'second brain', 'second brain ai', 'coding assessment', 'technical assessment',
    ...
    'replit ghostwriter', 'replit ai', 'replit copilot', 'replit chat', 'antigravity',
    'cursor', 'cursor ai', 'cursor chat', 'cursor copilot', 'cursor assistant',
    ...
    // AI voice assistants and Transcribers
    'alexa', 'google assistant', 'siri', 'cortana', 'bixby',
    'alexa app', 'google home', 'homepod', 'echo', 'google nest',
    'whisper', 'whisper ai', 'openai whisper', 'overlay', 'overlay ai',
    'otter', 'otter.ai', 'fireflies', 'fireflies.ai', 'tldv', 'tl;dv',
    'tactiq', 'fathom', 'read.ai', 'krisp',
    ...
    // Remote access tools
    'anydesk', 'teamviewer', 'chrome remote', 'chrome remote desktop',
    'remoting_host', 'vnc', 'realvnc', 'vnc viewer', 'vnc server',
    'rdp', 'remote desktop', 'microsoft remote desktop',
    'logmein', 'gotomypc', 'splashtop', 'ultraviewer', 'ammyy', 'supremo',
    'rustdesk', 'getscreen', 'parsec', 'moonlight',
    'zoho assist', 'zohoassist', 'connectwise', 'screenconnect', 'remotepc',

    // Communication apps
    'telegram', 'whatsapp', 'discord', 'slack', 'skype', 'zoom', 'teams',
    'hangouts', 'messenger', 'signal', 'wechat', 'viber', 'line',
    'microsoft teams', 'msteams', 'webex', 'cisco webex', 'gotomeeting', 'bluejeans',
    'google meet', 'meet', 'ringcentral', 'jitsi',
    ...
    'notepad++', 'notepad', 'gedit', 'kate', 'visual studio code', 'vscode', 'code',
    ...
    'obs', 'obs studio', 'obs64', 'obs32', 'streamlabs', 'xsplit', 'bandicam', 'fraps', 'camtasia',
    'screencast', 'screen recorder', 'sharex', 'greenshot', 'splitcam',
    ...
    'regedit', 'gpedit', 'cmd', 'powershell', 'terminal', 'autohotkey', 'ahk',
    ...
    // Contract Cheating / Answer Marketplaces
    'chegg', 'course hero', 'coursehero', 'brainly', 'studocu',
    'stack overflow', 'stackoverflow', 'fiverr', 'upwork', 'quizlet', 'scribd',
